...
public class Birra extends Prodotto implements ProdottoPrezzato {
	...
	public Birra(CategoriaProdotti categoria, String descrizione, String sigla,
	...
	public String toString() {
		return "Birra [iDProdotto=" + iDProdotto + ", sigla=" + sigla + ", prezzoSingolo=" + prezzoSingolo
