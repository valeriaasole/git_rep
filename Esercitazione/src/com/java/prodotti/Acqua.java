...
public class Acqua extends Prodotto implements ProdottoPrezzato {
	...
	public Acqua(CategoriaProdotti categoria, String descrizione, String sigla,
	...
	public String toString() {
		return "Acqua [iDProdotto=" + iDProdotto + ", sigla=" + sigla + ", prezzoSingolo=" + prezzoSingolo
